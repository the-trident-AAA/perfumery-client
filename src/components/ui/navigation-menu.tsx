...
const navigationMenuTriggerStyle = cva(
	"group inline-flex h-9 gap-2 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium bg-primary",
)
...
function NavigationMenuLink({
	...
	return (
		<NavigationMenuPrimitive.Link
			...
			className={cn(
				"data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-accent data-[active=true]:bg-accent/50 hover:bg-accent focus:bg-accent focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
				className,
			)}
			{...props}
		/>
