...
export default async function BestSellingProducts() {
	return (
		<section
			id="best-selling"
			className="relative w-full overflow-hidden bg-muted pt-8 pb-8"
		>
			...
			<div className="relative flex flex-col gap-1 z-10">
				...
				{/* Trust indicators */}
				<div className="flex px-4 sm:px-6 lg:px-8 flex-wrap items-center justify-center gap-6 md:gap-8 mt-4 md:mt-4 pt-6 border-t border-border">
