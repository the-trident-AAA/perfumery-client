...
import { getBestSellersPerfumes } from "@/src/lib/services/perfumes"
...
export default async function BestSellingProductsList() {
	const res = await getBestSellersPerfumes()
	if (!res.response || res.error)
		throw new Error("Error fetching best sellers perfumes")
